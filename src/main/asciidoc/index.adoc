...
=  Ascii doctor will assemble ( gromadzić ) things into single document and then uses it to produce single Html document
=  Ascii Docs looks at this index.adoc and generates generated-docs/index.html for us
Order Service Docs John Thompson; :doctype: book :icons: font :source-highlighter: highlightjs
...
= will be replace with these snippets
